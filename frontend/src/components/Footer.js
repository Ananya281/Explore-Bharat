...
const Footer = () => {
  return (
    <footer className="relative bg-[#6b4226] text-[#fdf7f2] py-14 overflow-hidden" style={{ minHeight: '350px' }}>
      {/* Decorative Patterns */}
      <div
      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 text-center md:text-left relative z-10">
        {/* About Section */}
        <div>
          <h3 className="font-bold text-xl mb-6">Explore Bharat</h3>
        ...
        <div>
          <h3 className="font-bold text-xl mb-6">Support Links</h3>
          <ul className="space-y-3 text-lg">
            <li><a href="/faq" className="hover:text-[#8c6239] transition duration-300">Ask a Question</a></li>
            <li><a href="/terms" className="hover:text-[#8c6239] transition duration-300">Delivery Terms</a></li>
            <li><a href="/careers" className="hover:text-[#8c6239] transition duration-300">Careers</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p className="text-lg">932 Galvin St. Pompano Beach, FL 33060</p>
          <p className="text-lg mt-4">example@example.com</p>
          <p className="text-lg mt-4">(334) 336 3346</p>
        </div>
      </div>
